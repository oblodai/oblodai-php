...
final class Enums
{
    ...
    public const ERROR_CODES = [
        ...
        'autopilot.freeze_unknown', 'autopilot.frozen', 'autopilot.gas_deep_deficit',
        'autopilot.gas_target_below_min', 'autopilot.usd_too_large', 'autowithdraw.bad_min', 'autowithdraw.missing',
        'batch.bad_id', 'batch.bad_recipient', 'batch.disabled', 'batch.duplicate_order_id',
        'batch.duplicate_reference', 'batch.empty', 'batch.invoice_required', 'batch.not_found',
        'batch.order_id_required', 'batch.reference_required', 'batch.too_large', 'batch.unsupported_kind',
        ...
        'confirmations.bad_tier', 'confirmations.no_network', 'confirmations.tier_too_large', 'db.unavailable',
        'deposit.generation_stale', 'discount.out_of_range', 'document.bad_format', 'document.bad_id',
        'document.bad_job_id', 'document.bad_kind', 'document.bad_signature', 'document.balance_unavailable',
        'document.batch_unavailable', 'document.daily_quota', 'document.disabled', 'document.encode_failed',
        'document.fees_unavailable', 'document.job_expired', 'document.job_failed', 'document.job_not_found',
        'document.job_not_ready', 'document.jobs_disabled', 'document.ledger_unavailable', 'document.link_expired',
        'document.no_split', 'document.not_found', 'document.render_failed', 'document.render_rejected',
        'document.render_unavailable', 'document.too_many_jobs', 'document.unknown_kind', 'document.unknown_lang',
        'document.wallet_abandoned', 'document.wallet_blocked', 'email.bad_recipient', 'email.disabled',
        'email.no_recipient', 'email.rate_limited', 'history.bad_merchant_id', 'idempotency.bad_key',
        'idempotency.in_progress', 'idempotency.key_reused', 'idempotency.unavailable', 'internal',
        'invoice.address_failed', 'invoice.already_paid', 'invoice.bad_deposit', 'invoice.bad_id',
        ...
        'merchant.bad_fee_bearer', 'merchant.bad_id', 'merchant.bad_project_id', 'merchant.bad_settles_to',
        'merchant.bad_signature', 'merchant.bad_subtract', 'merchant.close_unavailable', 'merchant.email_required',
        'merchant.key_mode_mismatch', 'merchant.no_owner', 'merchant.no_personal_wallet', 'merchant.not_found',
        'merchant.project_mismatch', 'merchant.secret_decrypt', 'merchant.unknown_key', 'minimum.negative',
        'minimum.no_network', 'onramp.admit', 'onramp.advance', 'onramp.already_delivered', 'onramp.bad_invoice',
        'onramp.bad_status', 'onramp.captured', 'onramp.expire', 'onramp.fail_captured', 'onramp.for_invoice',
        'onramp.force_completed', 'onramp.invoice_not_found', 'onramp.invoice_not_payable',
        'onramp.money_already_landed', 'onramp.no_evidence', 'onramp.no_refund_evidence', 'onramp.not_captured',
        'onramp.not_found', 'onramp.open', 'onramp.open_conflict', 'onramp.overdue', 'onramp.owner_required',
        'onramp.refund_evidence', 'onramp.release', 'onramp.suppressed_in', 'onramp.suppresses',
        'onramp.target_required', 'onramp.terminal', 'onramp.token', 'pay.bad_uuid', 'pay.below_minimum',
        ...
        'paylink.bad_id', 'paylink.bad_max', 'paylink.bad_min', 'paylink.bad_mode', 'paylink.bad_range',
        ...
        'payout.bad_kind', 'payout.bad_memo', 'payout.bad_owner_kind', 'payout.bad_state', 'payout.bad_status',
        ...
        'payout.memo_too_long', 'payout.no_destination', 'payout.no_lookup', 'payout.no_owner', 'payout.no_sender',
        'payout.no_txid', 'payout.no_user', 'payout.not_broadcasting', 'payout.not_found', 'payout.not_pending',
